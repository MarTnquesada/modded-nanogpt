...
def mm_backward_op(g: Tensor, x_f8: Tensor, w_f8: Tensor, x_s: float, w_s: float, grad_s: float) -> tuple[Tensor, Tensor]:
    ...
    def impl(grad: Tensor, x_f8: Tensor, w_f8: Tensor):
        ...
        # faster than grad_f8_t @ x_f8, for (d_out, d_in) == (28544, 1024)
...
class Hyperparameters:
    # data
    train_files: str = "data/fineweb-tokmon-10B/english-28416-balanced-v1/fineweb-tokmon_train_*.bin" # input .bin to train on
    val_files: str = "data/fineweb-tokmon-10B/english-28416-balanced-v1/fineweb-tokmon_val_*.bin" # input .bin to eval validation loss on
